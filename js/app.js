(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-banner__slider")) new core(".slider-banner__slider", {
            ...
            pagination: {
                el: ".slider-banner__pagination.swiper-pagination",
                clickable: true
            },
            on: {}
        });
        if (document.querySelector(".key-feature__slider")) new core(".key-feature__slider", {
            modules: [Navigation],
            direction: "vertical",
            slidesPerView: 1,
            spaceBetween: 30,
            ...
            speed: 800,
            navigation: {
                prevEl: ".key-feature-button-prev.swiper-button-prev",
                nextEl: ".key-feature-button-next.swiper-button-next"
            },
            on: {}
        });
    ...
    document.querySelector(".actions__btn").onclick = scrollIntoElemChoose;
    document.querySelector(".new-rs__btn").onclick = scrollIntoElemChoose;
    function scrollIntoElemChoose() {
        const elementChoose = document.querySelector(".page__choose");
        elementChoose.scrollIntoView({
            behavior: "smooth",
            block: "center",
            inline: "start"
        });
    ...
    document.getElementById("key-features").onclick = scrollIntoElemKeyFeatures;
    function scrollIntoElemKeyFeatures() {
        const elementKeyFeature = document.querySelector(".page__key-feature");
        elementKeyFeature.scrollIntoView({
            behavior: "smooth",
            block: "start",
            inline: "start"
        });
    ...
    document.getElementById("reviews").onclick = scrollIntoElemReviews;
    function scrollIntoElemReviews() {
        const elementReviews = document.querySelector(".page__reviews");
        elementReviews.scrollIntoView({
            behavior: "smooth",
            block: "start",
            inline: "start"
        });
    ...
    document.getElementById("techSpecs").onclick = scrollIntoElemTechSpecs;
    function scrollIntoElemTechSpecs() {
        const elementTechSpecs = document.querySelector(".page__tech-specs");
        elementTechSpecs.scrollIntoView({
            behavior: "smooth",
            block: "start",
            inline: "start"
        });
    ...
    document.getElementById("overview").onclick = scrollIntoElemOverview;
    function scrollIntoElemOverview() {
        const elementOverview = document.querySelector(".page__new-rs");
        elementOverview.scrollIntoView({
            behavior: "smooth",
            block: "start",
            inline: "start"
        });
    ...
    document.getElementById("home").onclick = scrollIntoElemHome;
    function scrollIntoElemHome() {
        const elementHome = document.querySelector(".page");
    ...
    videoContent.addEventListener("click", (() => {
        if (video.paused) {
            ...
            controlsBtn.classList.remove("controls__play-btn");
            controlsBtn.classList.add("controls__pause-btn");
        } else {
            video.pause();
            controlsBtn.classList.remove("controls__pause-btn");
            controlsBtn.classList.add("controls__play-btn");
            video.removeAttribute("controls");
        }
    }));


    let colorButtons = document.querySelectorAll("[data-color-left]");
    let colorButtons2 = document.querySelectorAll("[data-color-right]");
    let choiceImageLeft = document.querySelector(".choice__image--left img");
    let choiceImageRight = document.querySelector(".choice__image--right img");
    colorButtons.forEach((button => {
        button.addEventListener("click", updateProductImageLeft);
    }));
    colorButtons2.forEach((button => {
        button.addEventListener("click", updateProductImageRight);
    }));
    function updateProductImageLeft(event) {
        const selectedColor = event.target.hasAttribute("data-color-left") ? event.target.getAttribute("data-color-left") : "";
        const imageUrl = `img/choose/${selectedColor}.png`;
        choiceImageLeft.setAttribute("src", imageUrl);
    }
    function updateProductImageRight(event) {
        const selectedColor = event.target.hasAttribute("data-color-right") ? event.target.getAttribute("data-color-right") : "";
        const imageUrl = `img/choose/${selectedColor}.png`;
        choiceImageRight.setAttribute("src", imageUrl);
    }

    const popupLinkBtn = document.querySelector(".popup-link-btn");
    const popupClose = document.getElementById("popup-clos-btn");
    const popupOderOupen = document.getElementById("oder-popup");
    const popupInFormLinkBtn = document.querySelector(".popup-in-form-link-btn");
    const popupInFormClose = document.getElementById("popup-in-form-clos-btn");
    const popupInFormOupen = document.getElementById("popup-in-form");
    popupLinkBtn.addEventListener("click", (function () {
        popupOderOupen.classList.add("open");
        document.body.classList.add("scroll-lock");
    }));
    popupClose.addEventListener("click", (function () {
        popupOderOupen.classList.remove("open");
        document.body.classList.remove("scroll-lock");
    }));
    popupInFormLinkBtn.addEventListener("click", (function () {
        popupOderOupen.classList.remove("open");
        popupInFormOupen.classList.add("open");
    }));
    popupInFormClose.addEventListener("click", (function () {
        popupInFormOupen.classList.remove("open");
        document.body.classList.remove("scroll-lock");
    }));
    window["FLS"] = true;
    isWebp();
